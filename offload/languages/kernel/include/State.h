...
private:
  ...
  llvm::DenseMap<ol_device_handle_t, llvm::SmallVector<StreamTy *, 8>>
      DeviceStreamsMap;
  llvm::DenseMap<ol_device_handle_t, llvm::SmallVector<StreamTy *, 8>>
      DeviceBlockingStreamsMap;
  std::mutex DeviceDefaultStreamsMapMutex;
  std::mutex DeviceStreamsMapMutex;
  std::mutex DeviceBlockingStreamsMapMutex;
